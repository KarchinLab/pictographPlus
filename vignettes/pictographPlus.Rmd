...
The SSM file should contain at least sample, mutation, total_reads, alt_reads, chrom, start, and end columns. Tumor purity values can be entered but are not required. If no purity values are entered, PictographPlus will estimate purity.
